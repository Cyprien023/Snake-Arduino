...
void selectDirection() {
  ...
  // while (sx > 1700 && sx < 2000 && sy > 1700 && sy < 2000) {
...
void loop() {
  ...
  // unsigned long ancienTime = 0;
  // if ((millis() - ancienTime) >= dtime)
  // {
  //   pixelShow(pos_x_head,pos_y_head,COLOR);
  //   ancienTime = millis();
  // }
  //   Serial.print("millis = ");
  // Serial.println(millis()%dtime);
  // Serial.print("direction avant");
  //     Serial.println(direction);
  ...
  if (millis() % dtime < 1) {
    ...
    //     pixelShow(pos_x_head,pos_y_head,28000);
    //     // pixelShow(pos_x_food,pos_y_food,COLOR);
